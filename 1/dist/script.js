...
const modals = () => {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    const trigger = document.querySelectorAll(triggerSelector),
      //так мы сможем повесить на несколько элементов с одинаковым селектором одни  те же функции
    ...
    close.addEventListener('click', () => {
      //создаем событие для закрытия модального окна
    ...
    modal.addEventListener('click', e => {
      if (e.target === modal) {
        //проверка что если событие клика произашло именно на элементе модал то будет происходить закрытие 
        modal.style.display = 'none';
        // document.body.style.overflow = '';
...
const tabs = (headerSel, tabSel, contentSel, activeclass) => {
  ...
  header.addEventListener("click", e => {
    ...
    if (target && target.classList.contains(tabSel.replace(/\./, "")) || target.parentNode.classList.contains(tabSel.replace(/\./, ""))) {
      tabs.forEach((item, i) => {
